module constants
  ...
  real(dp),parameter ::mC_amu       = 12.011d0      ! C atom mass [amu]; IUPAC
  real(dp),parameter ::mN_amu       = 14.007d0      ! N atom mass [amu]; IUPAC
  real(dp),parameter ::mO_amu       = 15.999d0      ! O atom mass [amu]; IUPAC
  real(dp),parameter ::mNe_amu      = 20.180d0      ! Ne atom mass [amu]; IUPAC
  real(dp),parameter ::mMg_amu      = 24.305d0      ! Mg atom mass [amu]; IUPAC
  real(dp),parameter ::mSi_amu      = 28.085d0      ! Si atom mass [amu]; IUPAC
  real(dp),parameter ::mS_amu       = 32.06d0       ! S atom mass [amu]; IUPAC
