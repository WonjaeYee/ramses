...
#ifdef CALIMA
     ! DTM is a plain named variable, so it stays in the `else if` chain.  The
     ! dust IR bands it used to sit next to are handled in the `else` block
     ! below instead, along with the RTZ line variables.
