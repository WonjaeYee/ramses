...
module mechanical_commons
   ...
   integer(kind=4),parameter::nvarSN=13+nchem+nmetals
  ...
  ! common lists for SNe across different cpus
   ...
   real(dp),dimension(1:ncomm_max,1:nmetals)::mZSN_comm         ! metal mass of SNe 
   ...
   real(dp),dimension(1:ncomm_max,1:nmetals)::mZloadSN_comm     ! metals ejected + entrained
