...
#endif
#ifdef RT
  use rt_parameters, ONLY: ixHI, ixHII, iIons
#endif
  implicit none
#ifndef WITHOUTMPI
  include 'mpif.h'
...
#endif
                 if(log_sf) then
399                  format('SF z= ',f9.5,1x,' nH= ',f7.3,' N= ',I5,' eps_ff= ',f9.5,' alpha= ',f9.5,' metal=',f9.5)
                     write(*,399) 1./aexp-1,log10(d*scale_nH),nstar(i),sfr_ff(i),alpha_fk(i),log10(mett+1d-40)
                 endif
              else
                 nstar(i)=0
              endif
  ...
  if (myid==1) then
     ...
     !Kang added to print pop3 star formation
        ...
        write(*,'(" Level=",I6," New star=",I6," Tot=",I10," Mass=",1PE10.3," Lost=",1PE10.3,"%"," New pop3=",I6," Tot pop3=",I6)')&
             & ilevel,ntot_all,nstar_tot,mtot_all,mlost_all/mtot_all*100.,npop3_all,npop3_tot
        !print *,'##################################################################################'
     endif
  end if
  ...
  do igrid=1,ncache,nvector
     ...
     do ind=1,twotondim
        ...
        do i=1,nnew
           ...
           if (metal) then
              do imet=1,nmetals ! metal enichment
