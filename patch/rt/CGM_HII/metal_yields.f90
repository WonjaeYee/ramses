module metal_yields
   ...
   integer, parameter :: nmass_POP3_HMHN = 14
   ...
   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_Fe_POP3_SNII = &
                                             (/ &
                                             7.29D-04 + 7.00D-02 + 9.97D-04 + 5.67D-11, &
                                             1.24D-03 + 7.00D-02 + 1.14D-03 + 1.76D-10, &
                                             1.40D-03 + 7.00D-02 + 8.78D-04 + 8.07D-10, &
                                             1.42D-03 + 7.00D-02 + 8.67D-04 + 1.05D-09, &
                                             3.31D-03 + 7.00D-02 + 4.67D-04 + 2.31D-09, &
                                             4.09D-03 + 7.00D-02 + 4.83D-04 + 2.26D-10, &
                                             9.30D-03 + 7.02D-02 + 5.01D-04 + 1.41D-08 &
                                             /)

   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_O_POP3_SNII = &
                                             (/ &
                                             4.50D-01 + 1.69D-06 + 5.79D-08, &
                                             7.73D-01 + 1.57D-06 + 4.89D-06, &
                                             1.38D+00 + 2.79D-07 + 4.63D-06, &
                                             2.11D+00 + 6.83D-08 + 2.52D-08, &
                                             2.79D+00 + 1.49D-06 + 6.75D-07, &
                                             4.81D+00 + 1.88D-08 + 2.06D-09, &
                                             8.38D+00 + 1.42D-09 + 2.13D-07 &
                                             /)
   ...
   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_Si_POP3_SNII = &
                                             (/ &
                                             8.04D-02 + 7.50D-04 + 1.42D-03, &
                                             7.32D-02 + 2.39D-04 + 1.49D-04, &
                                             1.16D-01 + 4.42D-04 + 3.45D-04, &
                                             9.94D-02 + 1.82D-04 + 1.10D-04, &
                                             3.51D-01 + 2.71D-04 + 7.54D-05, &
                                             2.48D-01 + 5.88D-04 + 2.55D-04, &
                                             1.02D+00 + 2.60D-03 + 4.06D-03 &
                                             /)

   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_Ca_POP3_SNII = &
                                             (/ &
                                             2.92D-03 + 9.77D-07 + 6.46D-08 + 1.68D-05 + 1.07D-12 + 1.55D-17, &
                                             4.41D-03 + 1.23D-06 + 4.93D-08 + 2.21D-05 + 1.76D-12 + 4.21D-14, &
                                             4.40D-03 + 3.62D-06 + 3.39D-08 + 1.45D-05 + 9.27D-12 + 4.12D-16, &
                                             6.22D-03 + 1.28D-05 + 7.43D-08 + 1.45D-05 + 1.30D-10 + 4.40D-16, &
                                             2.48D-02 + 7.46D-06 + 1.58D-08 + 9.79D-06 + 2.78D-11 + 1.26D-11, &
                                             1.74D-02 + 8.62D-07 + 1.93D-09 + 5.44D-06 + 6.05D-13 + 3.55D-16, &
                                             3.73D-02 + 2.17D-05 + 9.65D-09 + 8.71D-06 + 5.20D-12 + 1.30D-17 &
                                             /)
   ...
   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_Mg_POP3_SNII = &
                                             (/ &
                                             8.62D-02 + 1.56D-04 + 7.07D-05, &
                                             6.82D-02 + 2.98D-04 + 3.98D-04, &
                                             1.57D-01 + 5.83D-04 + 8.73D-04, &
                                             1.50D-01 + 1.16D-04 + 2.38D-04, &
                                             1.20D-01 + 3.97D-05 + 5.01D-05, &
                                             2.26D-01 + 2.44D-04 + 1.29D-04, &
                                             4.78D-01 + 4.28D-04 + 1.25D-04 &
                                             /)

   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_Eu_POP3_SNII = &
                                             (/ &
                                             1.00D-40, 1.00D-40, 1.00D-40, 1.00D-40, &
                                             1.00D-40, 1.00D-40, 1.00D-40 &
                                             /)
   ...
   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_Ne_POP3_SNII = &
                                             (/ &
                                             1.53D-02 + 5.42D-07 + 1.98D-07, &
                                             3.27D-01 + 3.76D-05 + 1.61D-05, &
                                             4.94D-01 + 9.12D-05 + 2.57D-05, &
                                             9.12D-01 + 4.30D-05 + 6.92D-05, &
                                             5.33D-01 + 1.33D-05 + 2.02D-05, &
                                             8.51D-01 + 5.51D-05 + 8.57D-05, &
                                             3.07D-01 + 1.08D-05 + 6.75D-06 &
                                             /)

   real(dp), dimension(1:nmass_POP3_SNII) :: table_yield_S_POP3_SNII = &
                                             (/ &
                                             2.37D-02 + 8.98D-05 + 2.79D-04 + 1.48D-08, &
                                             3.20D-02 + 7.55D-05 + 2.02D-04 + 1.43D-09, &
                                             4.07D-02 + 1.03D-04 + 2.85D-04 + 5.34D-09, &
                                             5.31D-02 + 1.98D-04 + 4.90D-04 + 2.56D-09, &
                                             1.85D-01 + 2.74D-04 + 4.24D-04 + 3.41D-10, &
                                             1.16D-01 + 1.65D-04 + 8.42D-05 + 7.04D-10, &
                                             3.73D-01 + 8.10D-04 + 1.59D-03 + 3.19D-08 &
                                             /)
...
contains
   ...
   !---------------------------------------
   FUNCTION SNII_Fe_yield(mass, met, portinari)
      !---------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
      real(dp) :: SNII_Fe_yield

      if (.not. portinari) then
   ...
   !---------------------------------------
   FUNCTION SNII_O_yield(mass, met, portinari)
      !--------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_N_yield(mass, met, portinari)
      !--------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_Si_yield(mass, met, portinari)
      !--------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_Ca_yield(mass, met, portinari)
      !--------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_Al_yield(mass, met, portinari)
      !--------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_Mg_yield(mass, met, portinari)
      !--------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_Eu_yield(mass, met, portinari)
      !--------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_C_yield(mass, met, portinari)
      !---------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_S_yield(mass, met, portinari)
      !---------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
   ...
   !---------------------------------------
   FUNCTION SNII_Ne_yield(mass, met, portinari)
      !---------------------------------------
      real(dp), intent(in) :: mass, met
      logical, intent(in) :: portinari
