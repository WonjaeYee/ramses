...
#ifdef NOSYSTEM
  if(myid==1)call PXFMKDIR(TRIM(sedwrite_dir),LEN(TRIM(sedwrite_dir)),O'755',info)  
#else
...
!-------------------------------------------------------------------------
  ...
  do i=1,npartmax
     ...
     if(pop3.and.Z.lt.Zcrit_pop3)then
