      ...
      do jgrid = 1, numbl(icpu, ilevel)
         ...
         if (npart1 > 0) then
            ...
            do jpart = 1, npart1
               ...
               if (idp(ipart) .lt. 0 .and. mett .le. Zcrit_pop3) then
               ...
               if (ok) then
                  ...
                  if (son(ind_cell) == 0) then  ! leaf cell
                     ...
                     if (mass .ge. 11 .and. mass .le. 20) then
                        ...
                        mzejecta(1) = POP3_HMHN_Fe_yield(M_Hecore)/scale_msun !1=Fe Harley
                        mzejecta(2) = POP3_HMHN_O_yield(M_Hecore)/scale_msun  !2=O  Harley
                        mzejecta(3) = POP3_HMHN_N_yield(M_Hecore)/scale_msun  !3=N  Harley
                        mzejecta(4) = POP3_HMHN_Mg_yield(M_Hecore)/scale_msun !4=Mg Harley
                        mzejecta(5) = POP3_HMHN_Ne_yield(M_Hecore)/scale_msun !5=Ne Harley
                        mzejecta(6) = POP3_HMHN_Si_yield(M_Hecore)/scale_msun !6=Si Harley
                        mzejecta(7) = POP3_HMHN_Ca_yield(M_Hecore)/scale_msun !7=Ca Harley
                        mzejecta(8) = POP3_HMHN_C_yield(M_Hecore)/scale_msun  !8=C  Harley
                        mzejecta(9) = POP3_HMHN_S_yield(M_Hecore)/scale_msun  !9=S  Harley
...
399                     format('Ejected mass (Msun):',e9.2,' Fe=',e9.2,' O=',e9.2,' N=',e9.2,' Mg=',e9.2,' Ne=',e9.2,' Si=',e9.2,' Ca=',e9.2,' C=',e9.2,' S=',e9.2)
                        write(*,399) scale_msun*mejecta,scale_msun*mzejecta(1),scale_msun*mzejecta(2),scale_msun*mzejecta(3),scale_msun*mzejecta(4),scale_msun*mzejecta(5),scale_msun*mzejecta(6),scale_msun*mzejecta(7),scale_msun*mzejecta(8),scale_msun*mzejecta(9)
                     end if
      ...
      do icpu = 1, ncpu_send
         ...
         do i = 1, ncell_send
            ...
            if (icpuSN_comm_mpi(j, 2) .eq. cpu2send) then
               ...
               SNsend(11 + nmetals, ncc) = eSN_comm(i)
            end if
         end do ! i
