subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,initfile,multiple,nregion,region_type &
       ...
       & ,prad_region &
#endif
       & ,d_region,u_region,v_region,w_region,p_region,read_ic_part
  ...
  namelist/refine_params/x_refine,y_refine,z_refine,r_refine &
       ...
       & ,agg_geo_refine_rho_kpc, agg_geo_refine_z_kpc
  ...
  namelist/physics_params/cooling,haardt_madau,metal,isothermal &
       ...
       & ,A_SN, expN_SN, E_SNII, H2crit_SF, pop3, pop3_mass, Zcrit_pop3  &
       & ,stellar_winds, stellar_winds_file, use_initial_mass, use_particle_type &
       & ,snIa, A_snIa, E_SNIa, variable_yield_SNII, mass_loss_boost, chem_list  &
...
105 continue
  ...
  do i=1,nboundary
     ...
     if(metal) boundary_var(i,imetal)=d_bound(i)*z_bound(i)
  end do
