...
if(myid==1)then
print *,'==========ilevel,icount =', ilevel, icount
print *, 'dtnew(ilevel-1) = ', dtnew(ilevel-1)
print *, 'dtnew(ilevel  ) = ', dtnew(ilevel)
print *, 'dtold(ilevel-1) = ', dtold(ilevel-1)
print *, 'dtold(ilevel  ) = ', dtold(ilevel)
print *,'=========================='
endif
